...
(()=>{
    var vimeoModal = ()=>{
        const videoItems = document.querySelectorAll(".gl-video-item"), modalContainer = document.querySelector(".gl-video-modal"), iframe = document.querySelector("#gl-modal"), modalBackdrop = document.querySelector(".gl-modal-backdrop");
        if (!iframe) {
    ...
    window.addEventListener("DOMContentLoaded", function() {
        ...
        $("[data-btn='wrap']").each(function() {
            ...
            $(this).on("mouseenter", function(e) {
                ...
                (0, _gsap.gsap).set(clipEl, {
                    display: "flex"
                });
                (0, _gsap.gsap).fromTo(clipEl, {
        ...
        cards.forEach((e)=>{
            const card = e.querySelectorAll("[data-card=box]"), title = e.querySelectorAll("[data-card=text]");
            (0, _gsap.gsap).set(card, {
                autoAlpha: 1
            });
        ...
        forms.forEach((form)=>{
            ...
            function removeParcelItem(parcelContainer, removeButton) {
                ...
                if (parcelItems.length > 1) parcelContainer.removeChild(parcelItems[parcelItems.length - 1]);
                updateRemoveButtonVisibility(parcelContainer, removeButton);
            }
        ...
        let typeSplit = new (0, _splitTypeDefault.default)(".h-swap", {
            types: "words",
            tagName: "span"
        });
        $("[c-w]").each(function(index) {
            ...
            headings.each(function(index) {
                if (index > 0) tl.from($(this).find(".word"), {
                    yPercent: 120,
                    stagger: {
                        amount: 0.2
                    },
                ...
                if (index < headings.length - 1) tl.to($(this).find(".word"), {
                    delay: 1,
                    yPercent: -120,
                    stagger: {
                        amount: 0.2
        ...
        $(".hero-trigger").on("inview", function(event, isInView) {
            if (isInView) {
                ...
                if (myIndex > 0) {
                    $(".hero_heading").removeClass("is--active");
                    $(".hero_heading").eq(myIndex - 1).addClass("is--active");
                }
            }
        });
        $(document).ready(function() {
            $(".ticker").each(function(index) {
                ...
                let myCounter = new CountUp(thisId, startNumber, startNumber, decimals, 2, options);
                if (!myCounter.error) {
                    myCounter.start();
                ...
                } else console.error(myCounter.error);
            });
        });
    });
...
},{"gsap":"fPSuC","gsap/ScrollTrigger":"7wnFk","swiper":"iM6UL","split-type":"fvGAG","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fPSuC":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["hPIHA","igcvL"], "igcvL", "parcelRequirefe80")
